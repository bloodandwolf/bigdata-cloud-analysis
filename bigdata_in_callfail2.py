...
def __clean_data_all_data(callFailData):
    ...
    #callFailData = callFailData[callFailData['机型（default）'] == 'vivo Xplay6']
    ...
    # callFailData = callFailData[callFailData['失败原因'] == 'CALL_END_CAUSE_OPERATOR_DETERMINED_BARRING_V02']

    print('----------------------------' + str(callFailData.shape[0]))
#     x9_data = callFailData.loc[callFailData['机型（default）'] == 'vivo X9']
#     x9i_data = callFailData.loc[callFailData['机型（default）'] == 'vivo X9i']
#     print(len(set(x9_data['imei（default）'].tolist())))
#     print(len(set(x9i_data['imei（default）'].tolist())))
    ...
    # callFailData=callFailData[callFailData['机型（default）']=='vivo Y67']
...
def bigDataIn_plot_trend(path_raw_data, path_result):
    ...
    trend_dics_list['PLMN_CS'] = ['46000-GSM', '46001-UMTS', '46011-CDMA - 1xRTT',
                                  '46001-GSM', '46003-CDMA - 1xRTT', '46000-EDGE',
                                  '46000-GPRS', '46000-LTE', '46000-TD_SCDMA',
                                  '46001-HSPA', '46001-LTE', '46000-TD-SCDMA',
                                  '46001-GPRS', '46000-HSDPA', '46001-EDGE',
                                  '46000-UMTS']
